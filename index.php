...
<div class="container">
    ...
    <form method="post">
        ...
        <input type="text" name="proprietaire" placeholder="Nom du plongeur" required>
        ...
        <input type="number" step="0.1" name="v_bloc" value="7" required>
        ...
        <input type="number" name="f_cible" value="50" required>
    ...
    <div class="result">
        ...
        <hr>
        <p>Total O2 : <?php echo $resultat['o2_litres']; ?> Litres</p>
